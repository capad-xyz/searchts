...
- [x] **F8c** Remaining 2025 copy **not** in F8b: `docs/install.md`, `CLAUDE.md`, `searchts/guides/setup-*.md`. Same honesty as F8b. **`docs/troubleshooting.md` still twitter-cli proxy theater.** **Revisit:** next docs PR if agents still open troubleshooting.
...
| 2026-09-08 | **F8c** install.md + CLAUDE.md + guides match F8. troubleshooting.md still twitter-cli (parked). |
