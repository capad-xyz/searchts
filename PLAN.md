...
| 2026-09-08 | **Hare voice:** no em dashes in review copy. **Model** = exact spawn. A Grok Build sub-agent is remote. **ocx** = laptop model router (not OpenCode); see NAMES.md. |
