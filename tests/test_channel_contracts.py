...
def test_channel_active_backend_set_by_check(monkeypatch, tmp_path):
    ...
    # Keep any network-based channel checks deterministic.
...
def test_youtube_warns_when_node_only_and_no_config(monkeypatch, tmp_path):
    ...
    assert ch.active_backend == "yt-dlp"  # the binary is alive; the warn only concerns the JS runtime
...
def test_channel_can_handle_contract():
    url_samples = {
        "github": "https://github.com/panniantong/searchts",
