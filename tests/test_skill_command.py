# -*- coding: utf-8 -*-
"""Tests for 'searchts skill' command and _install_skill / _uninstall_skill."""
...
from searchts.cli import _install_skill, _uninstall_skill
...
class TestSkillCommand(unittest.TestCase):
    ...
    def test_skill_resources_include_both_locales(self):
        ...
        skill_dir = importlib.resources.files("searchts").joinpath("skill")
    ...
    def test_install_skill_creates_skill_md(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "searchts.cli.os.path.expanduser",
            ...
            for dirpath, _, filenames in os.walk(tmpdir):
                if "SKILL.md" in filenames:
                    ...
                    with open(os.path.join(dirpath, "SKILL.md"), encoding="utf-8") as f:
                        content = f.read()
                    self.assertIn("searchts", content)
    ...
    def test_uninstall_skill_removes_dir(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            skill_path = os.path.join(tmpdir, ".openclaw", "skills", "searchts")
    ...
    def test_install_creates_dir_if_parent_exists(self):
        """_install_skill should create searchts dir inside existing skill dir."""
        with tempfile.TemporaryDirectory() as tmpdir:
            # Create the .openclaw/skills parent but not searchts subdir
            ...
            target = os.path.join(skill_parent, "searchts", "SKILL.md")
    ...
    def test_install_uses_english_skill_for_english_locale(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertTrue(
                os.path.exists(os.path.join(skill_parent, "searchts", "references"))
            )
